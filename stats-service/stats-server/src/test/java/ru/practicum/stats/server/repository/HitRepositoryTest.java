...
class HitRepositoryTest {
    ...
    void aggregateQueries_shouldWork() {
        ...
        h1.setUri("/events");
        h1.setIp("10.0.0.1");
        h1.setTimestamp(LocalDateTime.parse("2025-11-04 12:00:00", ISO_DATE_TIME_FORMAT));
        ...
        h2.setUri("/events/1");
        h2.setIp("10.0.0.2");
        h2.setTimestamp(LocalDateTime.parse("2025-11-04 12:05:00", ISO_DATE_TIME_FORMAT));
        ...
        h3.setUri("/events/1");
        h3.setIp("10.0.0.2");
        h3.setTimestamp(LocalDateTime.parse("2025-11-04 12:06:00", ISO_DATE_TIME_FORMAT));
        hitRepository.save(h3);

        LocalDateTime start = LocalDateTime.parse("2025-11-04 00:00:00", ISO_DATE_TIME_FORMAT);
